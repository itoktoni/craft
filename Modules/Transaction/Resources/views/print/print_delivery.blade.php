...
<head>
    ...
    <title>Print Delivery Order {{ $master->{$master->getKeyName()} ?? '' }}</title>
    ...
    <div id='page'>
        <div>
            ...
            <div id="box">
                <h1>
                    <span>
                        NO. {{ str_replace('SO', 'DO', $master->{$master->getKeyName()}) ?? '' }}
                    </span>
                </h1>
                    ...
                    <td colspan="8">
                        <p>
                            ...
                            <strong style="font-size: 12px;">
                                Notes : {{ $master->so_notes_external }}
                            </strong>
                        </p>
                    </td>
                </tr>
