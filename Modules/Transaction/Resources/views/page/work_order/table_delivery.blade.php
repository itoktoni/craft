    ...
    <tbody class="markup">
        ...
        <tr>
            ...
            <td data-title="Sent" class="text-right col-lg-1">
                <input type="text" tabindex="{{ $loop->iteration }}1" name="detail[{{ $loop->index }}][temp_sent]" class="form-control input-sm text-right number temp_sent" value="{{ $item['temp_sent'] ?? $item->mask_sent }}">
