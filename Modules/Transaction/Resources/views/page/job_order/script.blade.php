        ...
        if (product_id) {
            ...
            if (product_name) {
                ...
                var markup = "<tr>" +
                    ...
                    "][temp_qty]' value='" + product_qty + "'></td>" +
                    "<td data-title='Price' class='text-right col-lg-1'>" +
                    "<input tabindex='" + counter + "2' name='detail[" + counter +
                    "][temp_price]' readonly class='form-control input-sm text-right number temp_price' value='" +
    ...
    $('#product').change(function(e) {
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result) {
                    var mask_price = number_format(result.service_price.toString());
